...
import SuggestionPage from '../../pageObjects/SugestionPage';
...
describe('Automation Practice Tests', function() {
  ...
  it('Suggestion - Type "South" and select "South Africa"', function() {
    // Type 'South' in the suggestion box
    suggestionPage.typeAndSelect('South');
    
    // Wait for the suggestion list to appear and select 'South Africa'
    cy.get('#autocomplete-list') // Replace with the actual selector for the suggestion list
  ...
  // You can add more tests for Web Table, iFrame interactions as per the requirements
});
